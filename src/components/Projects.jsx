    ...
    <section id="projects" className="section-padding bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      <div className="container-custom">
        ...
        >
          ...
          >
            {filterOptions.map((option) => (
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className={`px-6 py-3 rounded-2xl font-semibold transition-all duration-300 flex items-center space-x-3 shadow-lg ${
                  filter === option.key
          ...
          >
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-gray-200/50 dark:border-gray-700/50 inline-block">
              <h4 className="text-2xl font-bold text-secondary dark:text-light mb-6">
                {t('projects.statistics')}
              </h4>
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
                {filterOptions.slice(1).map((option) => (
                  <div key={option.key} className="text-center">
                    <div className="text-3xl font-bold bg-gradient-to-r from-primary to-primary-dark bg-clip-text text-transparent mb-2">
                      {option.count}
                    </div>
